...
= 5.8.2 - July 18, 2024 =
*   New: Introduce filter hook `wc_scapa_payment_channels`
...
*   Improve: Ensure order amount is in integer when initializing payment on Scapa
...
*   Update: Load Scapa InlineJS (Popup) V2 in the custom payment gateways

= 5.7.6 - June 20, 2023 =
*   New: Minimum WooCommerce supported version: 7.0
*   Fix: Unable to process refund on the view order screen
*   Improve: Scapa test mode notice will now be displayed in the WooCommerce Admin Notes Inbox

= 5.7.5 - May 22, 2023 =
*   Update: Add support for EGP as an accepted currency
*   Update: Update icon for Kenyan payment methods
*   Update: Migrate to Scapa InlineJS (Popup) V2
...
*   Fix: Scapa payment modal displaying on the "Pay for Order" page
...
= 5.7.2 - March 12, 2021 =
* New: Auto display Scapa payment popup on the payment page
* Removed: Remove Scapa metrics tracker
...
* Fix: The default gateway should display only the payment channel(s) set on the Scapa settings page
...
= 5.6.0 - August 7, 2019 =
*   New: Support for refunds via Scapa from the order details screen.
*   New: Log successful transaction to Scapa metrics tracker.
*   New: Add support for sending additional order details to Scapa when making payment using a saved card.
*   New: Add support for sending additional order details to Scapa when a subscription payment is renewed.
...
*   Misc: Remove Scapa fee and Scapa payout amount on the order details page
...
*   New: Add support for Scapa split payments
*   New: Display Scapa fee and Scapa payout amount on the order details page
...
*	Fix: Deprecated functions in the Tbz_WC_Gateway_Scapa_Subscription class
...
*	New: Add support for Scapa custom filters
*	New: Create additional Scapa gateways (max of 5) using different custom filters. You can create a gateway that accepts only Verve cards, a gateway that accepts only bank account payments, a gateway that accepts only GTB issued Mastercard.
...
= 4.0.0 - April 10, 2017 =
* 	New: Add support for Scapa Inline Embed.
*  	New: Add support for sending additional order details to Scapa

= 3.1.1 - February 13, 2017 =
* 	New: Changed Scapa payment methods icon.

= 3.1.0 - January 10, 2017 =
* 	New: Add support for USD and GBP currency. Note this has to be enabled by Scapa for your account before it can be used on your site.
...
= 2.0.1 - July 5, 2016 =
*	Fix: Scapa payment option and settings not available if Scapa WooCommerce Payment Gateway version 2.0.0 is installed and WooCommerce version 2.5.5 and below is installed

= 2.0.0 - June 28, 2016 =
* 	New: Saved cards - allow store customers to save their card details and pay again using the same card. Card details are saved on Scapa servers and not on your store.
*	Fix: Change payment icon

= 1.1.0 - April 22, 2016 =
*   Fix: Fatal error if the WooCommerce plugin is deactivated while the Scapa plugin is active
